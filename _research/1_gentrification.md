...
The code and a README for this project are available [here](https://github.com/joelcarlson/CityPredictions)!

Here is a modified version of the presentation I gave at [Galvanize](http://galvanize.com) related to this work:

<iframe src="//www.slideshare.net/slideshow/embed_code/key/1jnFGT0kzRoZXr" width="100%" height="400" frameborder="0" marginwidth="0" marginheight="0" scrolling="no"> </iframe> 
...
By the time I left, about two and a half years later, the area was cleaner, had more upscale businesses, and heavy pedestrian traffic. The rental prices had also *skyrocketed*. Looking around the area I saw new coffee shops, new bars, and significant night life. That is, liquor serving establishments (which need licenses), and people (who need transportation - taxis). I wondered - Did these precede the rent increases? 
